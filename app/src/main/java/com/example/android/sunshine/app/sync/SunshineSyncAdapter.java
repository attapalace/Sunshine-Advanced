...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    @IntDef({LOCATION_STATUS_OK, LOCATION_STATUS_SERVER_DOWN, LOCATION_STATUS_SERVER_INVALID , LOCATION_STATUS_UNKNOWN,LOCATION_STATUS_INVALED})
    public @interface LocationStatus {}
    public static final int LOCATION_STATUS_OK = 0;
    public static final int LOCATION_STATUS_SERVER_DOWN = 1;
    public static final int LOCATION_STATUS_SERVER_INVALID = 2;
    public static final int LOCATION_STATUS_UNKNOWN = 3;
    public static final int LOCATION_STATUS_INVALED = 4;

    public SunshineSyncAdapter(Context context, boolean autoInitialize) {
        super(context, autoInitialize);
    }

    // @param ContentProviderClient is a lightweight public interface to a content provider.
            ...
            if (forecastJson.has(OWM_MESSAGE_CODE)){
                ...
                switch (messageCode){
                    ...
                    case HttpURLConnection.HTTP_NOT_FOUND:
                        setLocationStatus(getContext() , LOCATION_STATUS_INVALED);
                        return;
                    default:
                        setLocationStatus(getContext(),LOCATION_STATUS_SERVER_DOWN);
                        return;
...
//                            Utility.getArtResourceForWeatherCondition(weatherId));
    ...
    static private void setLocationStatus(Context c,@LocationStatus int locationStatus){
        ...
        //we use commit here because this will not be called on the main thread
        spe.commit();
    }
}
