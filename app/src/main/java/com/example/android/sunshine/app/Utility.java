...
/**
 * Created by ahmedatta on 3/19/16.
 */
public class Utility {
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        String formatArtUrl = prefs.getString(context.getString(R.string.pref_art_pack_key),
                context.getString(R.string.pref_art_pack_mono));
    ...
    static public boolean IsNetworkAvailable(Context c){
        ...
        boolean isConnected = networkState!= null && networkState.isConnectedOrConnecting();
        return isConnected;
    }
     ...
     * @param c to the sharedPreferences
     */
    static public void ResetLocationStatus(Context c){
        ...
        // we use apply instead of submit since this will be called on the main thread
        spe.apply();
    }
    /**
     * Helper method to convert the database representation of the date into something to display
